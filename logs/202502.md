...
PHP_CONFIGURE_OPTIONS="--with-openssl=$(brew --prefix openssl) --with-iconv=$(brew --prefix libiconv)" mise install php

で行けるかな？

ref. https://github.com/asdf-community/asdf-php/issues/163 |
